...
If the user wishes to change any of the ranges or codes after entering data then they can change the dictionary and click `Re-format Exising Sheet` to update the validaion rules.
...
To show them all together on one page you can use the gggpubr package:
