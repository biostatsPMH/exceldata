...
[![R-CMD-check](https://github.com/lisa-avery/exceldata/workflows/R-CMD-check/badge.svg)](https://github.com/lisa-avery/exceldata/actions)
<!-- badges: end -->
...
Here](https://github.com/lisa-avery/exceldata/blob/main/images/DataDictionary0.9.1.xlsm)
and then click on `Download`

To view data in the required format without macros [Click
Here](https://github.com/lisa-avery/exceldata/blob/main/inst/extdata/exampleData.xlsx)
and then click on `Download`
...
``` r
devtools::install_github("lisa-avery/exceldata")
```
